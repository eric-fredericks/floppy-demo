...
class SampleControllerImpl(controllerComponents: ControllerComponents)(
  ...
  private[this] val postMethodWithRequestAndResponseContext
      : ActionContext[MyAppRequest] =
    postWithRequestAndResponseV2Context[MyAppRequest]
  private[this] val postMethodWithRequestAndResponseAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  ).withFloppyEars(postMethodWithRequestAndResponseContext)
  ...
  private[this] val postMethodWithRequestContext: ActionContext[MyAppRequest] =
    postWithRequestV3Context[MyAppRequest]
  private[this] val postMethodWithRequestAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  ).withFloppyEars(postMethodWithRequestContext)
  override def postMethodWithRequest(
      str1: String,
      int1: Int,
      str2: Option[String]
  ): EssentialAction = {
  ...
  private[this] val getMethodWithResponseContext: ActionContext[MyAppRequest] =
    getWithResponseV4Context[MyAppRequest]
  private[this] val getMethodWithResponseAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  ).withFloppyEars(getMethodWithResponseContext)
  ...
  private[this] val getWithNoParamContext =
    getWithNoParamV1Context[MyAppRequest]
  private[this] val getMethodWithNoParamAction
      : ActionBuilder[MyAppRequest, AnyContent] =
    MyActionBuilder(controllerComponents).withFloppyEars(getWithNoParamContext)
  ...
  private[this] val getMethodWithNoInterceptAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  )
  ...
  private[this] val postWithTransformationsContext =
    postWithTransformedRequestAndResponseV1Context[MyAppRequest]
  private[this] val postMethodWithTransformationsAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  ).withFloppyEars(postWithTransformationsContext)
  ...
  private[this] val anotherPostWithParsedBodyContext =
    anotherPostWithParsedBodyV1Context[MyAppRequest]
  private[this] val anotherPostWithParsedBodyAction
      : ActionBuilder[MyAppRequest, AnyContent] = MyActionBuilder(
    controllerComponents
  ).withFloppyEars(anotherPostWithParsedBodyContext)
  override def anotherPostMethodWithParsedBodyAndTransformations
      : EssentialAction = {
